 ...
 */
export function handleValidationError(message: string, details?: any): ApiError {
  return {
    success: false,
 ...
 */
export function handleAuthError(message: string = 'Unauthorized'): ApiError {
  return {
    success: false,
 ...
 */
export function handleForbiddenError(message: string = 'Forbidden'): ApiError {
  return {
    success: false,
    error: 'Access Denied',
    message,
 ...
 */
export function sendErrorResponse(c: Context, apiError: ApiError): Response {
  return c.json(apiError, apiError.statusCode as any);
}
