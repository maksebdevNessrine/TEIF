...
import { InvoiceLineUpdateManyWithoutInvoiceNestedInputSchema } from './InvoiceLineUpdateManyWithoutInvoiceNestedInputSchema';

export const InvoiceUpdateWithoutAllowancesInputSchema: z.ZodType<Prisma.InvoiceUpdateWithoutAllowancesInput> = z.object({
  ...
  lines: z.lazy(() => InvoiceLineUpdateManyWithoutInvoiceNestedInputSchema).optional(),
}).strict();

export default InvoiceUpdateWithoutAllowancesInputSchema;
