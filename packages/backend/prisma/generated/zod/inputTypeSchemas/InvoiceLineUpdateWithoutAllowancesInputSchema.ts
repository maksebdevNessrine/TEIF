...
import { InvoiceUpdateOneRequiredWithoutLinesNestedInputSchema } from './InvoiceUpdateOneRequiredWithoutLinesNestedInputSchema';

export const InvoiceLineUpdateWithoutAllowancesInputSchema: z.ZodType<Prisma.InvoiceLineUpdateWithoutAllowancesInput> = z.object({
  ...
  invoice: z.lazy(() => InvoiceUpdateOneRequiredWithoutLinesNestedInputSchema).optional(),
}).strict();

export default InvoiceLineUpdateWithoutAllowancesInputSchema;
