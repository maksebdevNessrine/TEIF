...
export const UserUncheckedCreateWithoutSignatureInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutSignatureInput> = z.object({
  id: z.cuid().optional(),
  email: z.string(),
  name: z.string(),
...
export default UserUncheckedCreateWithoutSignatureInputSchema;
