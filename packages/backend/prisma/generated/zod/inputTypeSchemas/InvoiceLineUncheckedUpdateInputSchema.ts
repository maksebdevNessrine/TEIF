...
export const InvoiceLineUncheckedUpdateInputSchema: z.ZodType<Prisma.InvoiceLineUncheckedUpdateInput> = z.object({
  ...
  allowances: z.lazy(() => AllowanceChargeUncheckedUpdateManyWithoutLineNestedInputSchema).optional(),
}).strict();

export default InvoiceLineUncheckedUpdateInputSchema;
