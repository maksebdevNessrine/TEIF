...
export const UserSignatureUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.UserSignatureUncheckedCreateWithoutUserInput> = z.object({
  id: z.cuid().optional(),
...
export default UserSignatureUncheckedCreateWithoutUserInputSchema;
