...
export const UserSignatureUncheckedCreateInputSchema: z.ZodType<Prisma.UserSignatureUncheckedCreateInput> = z.object({
  id: z.cuid().optional(),
  userId: z.string(),
...
export default UserSignatureUncheckedCreateInputSchema;
