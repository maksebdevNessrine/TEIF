...
export const UserSignatureCreateWithoutUserInputSchema: z.ZodType<Prisma.UserSignatureCreateWithoutUserInput> = z.object({
  id: z.cuid().optional(),
...
export default UserSignatureCreateWithoutUserInputSchema;
