...
import { InvoiceLineUncheckedUpdateManyWithoutInvoiceNestedInputSchema } from './InvoiceLineUncheckedUpdateManyWithoutInvoiceNestedInputSchema';
...
export const InvoiceUncheckedUpdateWithoutSupplierInputSchema: z.ZodType<Prisma.InvoiceUncheckedUpdateWithoutSupplierInput> = z.object({
  ...
  amountLanguage: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  lines: z.lazy(() => InvoiceLineUncheckedUpdateManyWithoutInvoiceNestedInputSchema).optional(),
  allowances: z.lazy(() => AllowanceChargeUncheckedUpdateManyWithoutInvoiceNestedInputSchema).optional(),
}).strict();

export default InvoiceUncheckedUpdateWithoutSupplierInputSchema;
