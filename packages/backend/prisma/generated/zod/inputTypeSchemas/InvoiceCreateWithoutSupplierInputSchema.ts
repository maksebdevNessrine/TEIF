...
import { PartnerCreateNestedOneWithoutBuyerInvoicesInputSchema } from './PartnerCreateNestedOneWithoutBuyerInvoicesInputSchema';
...
export const InvoiceCreateWithoutSupplierInputSchema: z.ZodType<Prisma.InvoiceCreateWithoutSupplierInput> = z.object({
  id: z.cuid().optional(),
  ...
  buyer: z.lazy(() => PartnerCreateNestedOneWithoutBuyerInvoicesInputSchema),
...
export default InvoiceCreateWithoutSupplierInputSchema;
