...
export const UserCreateWithoutSignatureInputSchema: z.ZodType<Prisma.UserCreateWithoutSignatureInput> = z.object({
  id: z.cuid().optional(),
  email: z.string(),
  name: z.string(),
...
export default UserCreateWithoutSignatureInputSchema;
