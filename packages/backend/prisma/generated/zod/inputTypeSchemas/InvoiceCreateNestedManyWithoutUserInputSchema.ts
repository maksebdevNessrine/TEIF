...
export const InvoiceCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.InvoiceCreateNestedManyWithoutUserInput> = z.object({
...
export default InvoiceCreateNestedManyWithoutUserInputSchema;
