...
import { InvoiceLineCreateInputSchema } from '../inputTypeSchemas/InvoiceLineCreateInputSchema'
import { InvoiceLineUncheckedCreateInputSchema } from '../inputTypeSchemas/InvoiceLineUncheckedCreateInputSchema'
import { InvoiceLineUpdateInputSchema } from '../inputTypeSchemas/InvoiceLineUpdateInputSchema'
import { InvoiceLineUncheckedUpdateInputSchema } from '../inputTypeSchemas/InvoiceLineUncheckedUpdateInputSchema'
...
export const InvoiceLineUpsertArgsSchema: z.ZodType<Prisma.InvoiceLineUpsertArgs> = z.object({
  ...
  create: z.union([ InvoiceLineCreateInputSchema, InvoiceLineUncheckedCreateInputSchema ]),
  update: z.union([ InvoiceLineUpdateInputSchema, InvoiceLineUncheckedUpdateInputSchema ]),
}).strict();

export default InvoiceLineUpsertArgsSchema;
