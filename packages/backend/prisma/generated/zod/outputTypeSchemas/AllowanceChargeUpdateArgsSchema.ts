...
export const AllowanceChargeUpdateArgsSchema: z.ZodType<Prisma.AllowanceChargeUpdateArgs> = z.object({
  select: AllowanceChargeSelectSchema.optional(),
  include: z.lazy(() => AllowanceChargeIncludeSchema).optional(),
  data: z.union([ AllowanceChargeUpdateInputSchema, AllowanceChargeUncheckedUpdateInputSchema ]),
  where: AllowanceChargeWhereUniqueInputSchema, 
}).strict();

export default AllowanceChargeUpdateArgsSchema;
