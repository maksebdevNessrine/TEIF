...
export const UserSignatureCreateArgsSchema: z.ZodType<Prisma.UserSignatureCreateArgs> = z.object({
  select: UserSignatureSelectSchema.optional(),
  include: z.lazy(() => UserSignatureIncludeSchema).optional(),
  data: z.union([ UserSignatureCreateInputSchema, UserSignatureUncheckedCreateInputSchema ]),
}).strict();

export default UserSignatureCreateArgsSchema;
