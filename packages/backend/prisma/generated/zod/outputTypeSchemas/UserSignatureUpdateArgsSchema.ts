...
export const UserSignatureUpdateArgsSchema: z.ZodType<Prisma.UserSignatureUpdateArgs> = z.object({
  select: UserSignatureSelectSchema.optional(),
  include: z.lazy(() => UserSignatureIncludeSchema).optional(),
  data: z.union([ UserSignatureUpdateInputSchema, UserSignatureUncheckedUpdateInputSchema ]),
  where: UserSignatureWhereUniqueInputSchema, 
}).strict();

export default UserSignatureUpdateArgsSchema;
