...
export const SignatureAuditFindUniqueArgsSchema: z.ZodType<Prisma.SignatureAuditFindUniqueArgs> = z.object({
  select: SignatureAuditSelectSchema.optional(),
  where: SignatureAuditWhereUniqueInputSchema, 
}).strict();

export default SignatureAuditFindUniqueArgsSchema;
