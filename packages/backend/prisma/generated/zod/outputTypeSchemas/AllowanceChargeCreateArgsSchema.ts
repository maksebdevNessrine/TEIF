...
export const AllowanceChargeCreateArgsSchema: z.ZodType<Prisma.AllowanceChargeCreateArgs> = z.object({
  select: AllowanceChargeSelectSchema.optional(),
  include: z.lazy(() => AllowanceChargeIncludeSchema).optional(),
  data: z.union([ AllowanceChargeCreateInputSchema, AllowanceChargeUncheckedCreateInputSchema ]),
}).strict();

export default AllowanceChargeCreateArgsSchema;
