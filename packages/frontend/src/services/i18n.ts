...
export const translations = {
  ar: {
    ...
    confirmRevokeSignature: 'هل أنت متأكد أنك تريد إلغاء الشهادة؟',
    ...
    days: 'أيام',
    revokeCertificate: 'سحب الشهادة',
    revokeInfo: 'سيؤدي السحب إلى إزالة شهادتك. يمكنك تحميل واحدة جديدة في أي وقت.',
    uploadNewCertificate: 'تحميل شهادة جديدة',
    header: 'الرأس',
    footer: 'تذييل الصفحة',
  ...
  en: {
    ...
    confirmRevokeSignature: 'Are you sure you want to revoke your certificate?',
    userId: 'User ID',
    ...
    revokeInfo: 'Revoking will remove your certificate. You can upload a new one anytime.',
