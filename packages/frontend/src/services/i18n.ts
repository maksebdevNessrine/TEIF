...
export const translations = {
  ar: {
    ...
    digitalSignature: 'شهادة التوقيع الرقمي',
    noCertificateMsg: 'لم تقم بتحميل شهادة توقيع رقمية بعد. قم بتحميل واحدة لبدء توقيع الفواتير.',
    header: 'الرأس',
    footer: 'تذييل الصفحة',
  ...
  en: {
    ...
    name: 'Name',
      ...
      digitalSignature: 'Certificat de signature numérique',
      noCertificateMsg: 'Vous n\'avez pas encore téléchargé de certificat de signature numérique. Téléchargez-en un pour commencer à signer des factures.',
      header: 'En-tête',
      footer: 'Pied de page',
    signIn: 'Sign In',
    signUp: 'Sign Up',
    ...
    noCertificateMsg: "You haven't uploaded a digital signature certificate yet. Upload one to start signing invoices.",
    header: 'Header',
    footer: 'Footer',
